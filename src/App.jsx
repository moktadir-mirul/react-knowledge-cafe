    ...
    <>
        <div className='w-11/12 flex justify-between py-5 mx-auto'>
          ...
          <div className='flex gap-5 items-center'>
            {
              !user ? <button onClick={handleLogInG} className='btn btn-primary'>Sing in with Google</button> : <div>
                <img className='w-28 h-28 rounded-full object-cover ' src={user.photoURL} alt={user.displayName} />
              <div>
